      ...
      <Container fluid className="pt-5">
        <Container>
          <Row className="footer-row">
            <Col lg={6} md={12} className="footer-col1">
              <div className="footer-wrapper w-50">
            ...
            <Col lg={2} md={4} sm={12} xs={12} className="footer-col2">
            ...
            <Col lg={2} md={4} sm={12} xs={12} className="footer-col3">
              <h5 className="mb-2 footer-text3">
